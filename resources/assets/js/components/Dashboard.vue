	            ...
	            <div class="section-padding">
	                <div class="container">
	                    <h2 class="section-title">
	                    	{{ title }}
	                    	<button class="btn btn-success float-right" @click=newModal>Schedule Lecture <i class="fa fa-plus fa-fw"></i></button>
	                    </h2>
	                </div>
	            </div>
	        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="course-items">
                       		<span v-if="lectures.length">
                            	<div class="row">
	                                <div class="col-md-4" v-for="lecture in lectures.data" :key="lecture.id">
	                                    <div class="item">
	                                        <div class="item-thumb">
	                                        	<img v-bind:src="lecture.image" alt="Item Thumbnail">
	                                        </div>
	                                        ...
	                                        <div class="item-details">
	                                            ...
	                                            <span class="instructor">
	                                            	<p style="text-align:justify; height:110px">{{ lecture.description }}</p>
	                                            </span>

	                                            <div class="details-bottom">
	                                            	<span class="instructor">
		                                                <p style="padding:5px">Start Time: {{ lecture.start_time | myDateTime }}</p>

		                                              	<p style="padding:5px">End Time: {{ lecture.end_date | myDateTime }}</p>
		                                            </span>
	                                                <div class="course-price" style="padding:15px">
	                                                	<span v-if="currentUser.type==1">
		                                                	<b-button block variant="primary" :href="lecture.link" target="_blank">
		                                                		Start Class
		                                                	</b-button>
		                                                </span>
				          	...
				          	<span v-else>
                            	<b-alert variant="success" show class="mt-5">
                            		<h2 style="padding:10px; color:blue"> No Online Class Schedule</h2>
                            	</b-alert>
                            </span>
                        </div>
                    </div>
		              ...
		              <div class="form-group">
		                ...
		                <has-error :form="form" field="topic_name"></has-error>
		              	...
		              	<div class="form-group">
		                	...
		                	<input v-model="form.topic_name" type="text" name="topic_name"
		                  class="form-control" placeholder="Lecture Topic" :class="{ 'is-invalid': form.errors.has('topic_name') }">
		                	<has-error :form="form" field="topic_name"></has-error>
		              	</div>
